...
import com.velocitypowered.api.event.connection.PreConnectEvent;
...
public class LoginSessionHandler implements MinecraftSessionHandler {
    ...
    private void preConnect(ConnectedPlayer player) {
        ...
        server.getEventManager().fire(new PreConnectEvent(player, toTry.orElse(null))).thenAcceptAsync(preConnectEvent -> {
            ...
            finishLogin(player, preConnectEvent.getServer());
        }, mcConnection.eventLoop());
    }

    private void finishLogin(ConnectedPlayer player, RegisteredServer registeredServer) {
                ...
                .thenAcceptAsync(event -> {
                    ...
                    if (reason.isPresent()) {
                        ...
                        server.getEventManager().fire(new PostLoginEvent(player))
                                .thenRun(() -> player.createConnectionRequest(registeredServer).fireAndForget());
                    }
                }, mcConnection.eventLoop());
    }
